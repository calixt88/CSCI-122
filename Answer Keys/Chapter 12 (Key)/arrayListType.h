...
public:
    ...
    bool isItemAtEqual(int location, int item) const;
      ...
      //Postcondition: Returns true if list[location] is the same as item; 
      //               otherwise, returns false.
    ...
    virtual void insertAt(int location, int insertItem) = 0;
      ...
      //Postcondition: Starting at location, the elements of the list are shifted down, list[location] = insertItem; length++;
      //               If the list is full or location is out of range, an appropriate message is displayed.

    virtual void insertEnd(int insertItem) = 0;
      //Function to insert insertItem at the end of the list. Note that this is an abstract function
    ...
    int retrieveAt(int location) const;
      //Function to return the element from the list at the position specified by location 
      //Postcondition: returns list[location], if location is out of range, the is terminated.
